...
static int list = 0;         /* list the file contents (-l) */
       int show_progress = 0;/* show progress (-p) */
...
off_t ifsize = -1;          /* if input is a file, size of it */
    ...
    char *iname;
{
    ...
    /* moved here because we need to do this before we first
    ...
    /* make sure it gets the file sizes right; get_method
     * might mess stuff up
     */
    if(show_progress) display_progress();
